...
public class Main {
    ...
    static void main() {
        ...
        Collections.replaceAll(deck, tensOfClubs, tenOfHearts);
        Card.printDeck(deck.subList(32, 36), "Tens row", 1);

        Collections.replaceAll(deck, tenOfHearts, tensOfClubs);
        Card.printDeck(deck.subList(32, 36), "Tens row", 1);

        if (Collections.replaceAll(deck, tenOfHearts, tensOfClubs)) {
        ...
        System.out.println("Ten of Clubs Cards = " +
                Collections.frequency(deck, tensOfClubs));
