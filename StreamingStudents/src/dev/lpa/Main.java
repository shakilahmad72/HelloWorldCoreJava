...
//                .forEach(System.out::println);
        ...
        for (String gender : List.of("M", "F", "U")) {
            ...
            System.out.println("# of " + gender + " student " + myStudents.count());
        }
        ...
        System.out.println("Seat for Enrollment Age = " + ageStream.summaryStatistics());

        var currentAgeStream = Arrays.stream(students).
                mapToInt(Student::getAge);
        System.out.println("Seat for Current Age = " + currentAgeStream.summaryStatistics());
